...
## Project Overview
This is the official ApexOS CLI tool written in Go, providing command-line
interface to interact with the ApexOS Supervisor. The CLI enables users to
...
- **Config File**: Optional config file support (default: `$HOME/.apexos.yaml`)

## Build Commands
- **Build**: `CGO_ENABLED=0 go build -ldflags="-s -w" -o "apex"`
- **Test**: `go test ./...`
- **Format**: `gofmt -s`
...
- Resty for HTTP API calls to ApexOS Supervisor
...
This CLI is designed to work with ApexOS Supervisor API and is commonly used in
ApexOS Operating System environments, SSH apps, and development setups.

## AI policy

This project follows the [Apex Infosys India AI Policy](../AI_POLICY.md).
