...
var multicastStatsCmd = &cobra.Command{
	...
	Short:   "Provides system usage stats of the ApexOS Multicast server",
	Long: `
Provides insight into the system usage stats of the ApexOS Multicast server.
It shows you how much CPU, memory, disk & network resources it uses.
`,
	Example: `
  apex multicast stats
`,
