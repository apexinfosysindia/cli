...
`,
	Example: `
  apex network update eth0 --ipv4-method auto --ipv6-method disabled
`,
...
func init() {
	...
	networkUpdateCmd.Flags().StringArray("ipv4-address", []string{}, "IPv4 address for the interface in CIDR notation (e.g. 192.168.1.5/24)")
