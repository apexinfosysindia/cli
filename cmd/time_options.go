...
var timeOptionsCmd = &cobra.Command{
	...
	Short:   "Set ApexOS time options",
	Long: `
This command allows you to set ApexOS NTP servers and fallback NTP
servers.`,
	Example: `
  apex time options --servers pool.ntp.org --servers time.cloudflare.com
  apex time options --fallback-servers time.google.com
  apex time options --clear-fallback-servers`,
