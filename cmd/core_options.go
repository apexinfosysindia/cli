...
var coreOptionsCmd = &cobra.Command{
	...
	Short:   "Allow to set options on ApexOS Core instance",
	Long: `
This command allows you to set configuration options for the ApexOS Core
instance running on your ApexOS system.`,
	Example: `
  apex core options --backups-exclude-database=true`,
...
func init() {
	...
	coreOptionsCmd.Flags().Bool("backups-exclude-database", false, "Backups exclude ApexOS database file by default")
