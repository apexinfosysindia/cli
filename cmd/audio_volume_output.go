...
var audioVolumeOuputCmd = &cobra.Command{
	Use:     "output",
	Aliases: []string{"out"},
	Short:   "Set volume of a ApexOS Audio output channel",
	Long: `
This command allows you to set the volume of a ApexOS Audio
output channel or application on your ApexOS system.`,
	Example: `
	apex audio volume output --index 1 --mute
	apex audio volume output --index 1 --unmute
	apex audio volume output --index 1 --volume 75
	apex audio volume output --index 1 --mute --application
	apex audio volume output --index 1 --unmute --application
	apex audio volume output --index 2 --volume 50 --application
`,
	ValidArgsFunction: cobra.NoFileCompletions,
	Args:              cobra.NoArgs,
	Run: func(cmd *cobra.Command, args []string) {
		slog.Debug("audio volume output", "args", args)
