...
var appsRebuildCmd = &cobra.Command{
	...
	Short:   "Rebuild a locally built ApexOS app",
	Long: `
Most apps provide pre-built images ApexOS can download and use.
...
`,
	Example: `
  apex apps rebuild local_my_app
  apex apps rebuild local_my_app --force
`,
