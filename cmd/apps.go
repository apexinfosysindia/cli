...
var appsCmd = &cobra.Command{
	...
	Short:   "Install, update, remove and configure ApexOS apps",
	Long: `
The apps command allows you to manage ApexOS apps by exposing
commands for installing, removing, configure and control them. It also provides
information commands for apps.`,
	Example: `
  apex apps logs core_ssh
  apex apps install core_ssh
  apex apps start core_ssh`,
